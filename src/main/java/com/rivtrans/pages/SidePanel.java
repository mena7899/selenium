...
//	}
	...
	public void clickH3Button(By H3) throws InterruptedException {
		WaitUtility.fluentWaitUntilVisible(6, licenses_button_h1, 2);
		click(licenses_button_h1);
		WaitUtility.fluentWaitUntilVisible(6, main_data_h2, 2);
		click(main_data_h2);
    ...
    public void clickCitiesButton() throws InterruptedException {
        clickH3Button(cities_button_h3);
    }

    public void clickMotorStateButton() throws InterruptedException {
